...
public class TestKafkaConfig {
    ...
    public TestKafkaConfig(KafkaProperties kafkaProperties) {
        this.kafkaProperties = kafkaProperties;
    }

    @Bean
    public ProducerFactory<String, LinkLifecycleEvent> linkLifecycleEventProducerFactory() {
    ...
    @Bean
    public KafkaTemplate<String, LinkLifecycleEvent> linkLifecycleEventKafkaTemplate() {
        return new KafkaTemplate<>(linkLifecycleEventProducerFactory());
    }
